...
| [no-any](src/rules/no-any/documentation.md)                                           | Using values of type `any` is not supported! Use `unknown` instead.                                              | 🔧 | 💡 |    |
...
| [no-private-identifier](src/rules/no-private-identifier/documentation.md)             | Disallows the use of private identifiers (`#`).                                                                  | 🔧 |    |    |
